...
curl https://raw.githubusercontent.com/Zuz99/Mantap/main/ssh/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/Zuz99/Mantap/main/ssh/vps.conf > /etc/nginx/conf.d/vps.conf
...
sed -i '$ iproxy_pass http://0.0.0.0:8000;' /etc/nginx/conf.d/xray.conf
...
sed -i '$ ilocation = /xrayws' /etc/nginx/conf.d/xray.conf
sed -i '$ i{' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_redirect off;' /etc/nginx/conf.d/xray.conf
...
sed -i '$ ilocation = /xrayssws' /etc/nginx/conf.d/xray.conf
sed -i '$ i{' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_redirect off;' /etc/nginx/conf.d/xray.conf
...
#rm /etc/nginx/sites-enabled/default
#rm /etc/nginx/sites-available/default
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Zuz99/aws/main/nginx.conf"

Index_port='81'
IPADDR=$(wget -qO- icanhazip.com);
# creating page download Openvpn config file
mkdir -p /home/vps/public_html
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/Zuz99/aws/main/lain2/index.html"
...
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/Zuz99/aws/main/vps.conf"
systemctl restart nginx
...
# websocket-python
wget "https://raw.githubusercontent.com/Zuz99/aws/main/websocket-python/websocket.sh"
chmod +x websocket.sh
screen -S websocket ./websocket.sh
#OpenVPN

wget "https://raw.githubusercontent.com/Zuz99/aws/main/install/vpn.sh"
chmod +x vpn.sh
./vpn.sh

# install badvpn
#wget -O /usr/bin/badvpn-udpgw "https://github.com/Zuz99/aws/raw/main/badvpn-udpgw64"
...
wget "https://raw.githubusercontent.com/Zuz99/aws/main/bbr.sh" && chmod +x bbr.sh && ./bbr.sh
wget "https://raw.githubusercontent.com/Zuz99/aws/main/set-br.sh" && chmod +x set-br.sh && ./set-br.sh
