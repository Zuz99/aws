...
wget -O /usr/bin/xp-l2tp https://raw.githubusercontent.com/${GitUser}/aws/main/xp-l2tp.sh && chmod +x /usr/bin/xp-l2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/${GitUser}/aws/main/tambah/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/${GitUser}/aws/main/hapus/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/xp-pptp https://raw.githubusercontent.com/${GitUser}/aws/main/xp-pptp.sh && chmod +x /usr/bin/xp-pptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/${GitUser}/aws/main/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/${GitUser}/aws/main/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
